...
[ # 0: Dvorak
    ...
    KC.LSFT, DV.SCLN, DV.Q,    DV.J,    DV.K,    DV.X, KC.TT(1), KC.LT(4, KC.ESC), DV.B,  DV.M,  DV.W,  DV.V,  DV.Z,  XXXXXXX,  \
...
[ # 2: Num
    KC.TO(2), _______, _______, _______, _______, _______,                         _______, _______, _______, _______, _______, _______, \
    ...
    DV.COLN, _______, _______, DV.LCBR, DV.RCBR, KC.BSLS, XXXXXXX,      KC.TO(0), DV.EQL,  KC.N1, KC.N2, KC.N3, KC.N0, DV.COLN, \
                           XXXXXXX, KC.SPC,  KC.BSPC, KC.LALT,             _______, _______, KC.SPACE, XXXXXXX,
